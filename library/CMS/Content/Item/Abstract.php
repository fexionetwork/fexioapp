...
include (realpath(dirname(__FILE__) . '/../../../../application/models/DbTable/ContentNode.php'));
...

{
	...
	{
		$this->_pageModel = new Application_Model_DbTable_Page();
		if (null != $pageId )
		{
	...
	public function loadPageObject($id)
	{
		...
		if ($row)
		{
			...
			$contentNode = new Application_Model_DbTable_ContentNode();
